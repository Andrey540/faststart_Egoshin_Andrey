...
BOOST_FIXTURE_TEST_SUITE(Picture_draft, Picture_draft_)
	...
	{
		CShapePoint top = CShapePoint(1, 1);
		CShapePoint bottom = CShapePoint(2, 2);
		unique_ptr<CRectangle> shape1 = make_unique<CRectangle>("red", top, bottom);
		CShape & refShape1 = *shape1;
		unique_ptr<CRectangle> shape2 = make_unique<CRectangle>("red", top, bottom);
		CShape & refShape2 = *shape2;
		unique_ptr<CRectangle> shape3 = make_unique<CRectangle>("red", top, bottom);
